import React, { useState, useEffect, useRef, PropsWithoutRef, ComponentState } from 'react';
...
export default function useMergeValue<T>(
	...
	const [stateValue, setStateValue] = useState<T>(!isUndefined(value) ? value : !isUndefined(defaultValue) ? defaultValue : defaultStateValue);
